...
namespace AttributeAnalyzer {
    ...
    internal class DataFormatResources {
        ...
        /// <summary>
        ///   查找类似 {0} can not applied to {1} type property 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 DataFormat and property type not match 的本地化字符串。
        /// </summary>
