...
public class CustomCSharpMigrationsGenerator : MigrationsCodeGenerator
{
    ...
    /// </summary>
    /// <param name="_dbContextOptions">migrationsAssembly.</param>
    ...
    {
        return _dbContextOptions.Extensions.Select(x => x.GetType().Name).Where(x => x != nameof(CoreOptionsExtension)).FirstOrDefault();
    }
    /// <summary>
