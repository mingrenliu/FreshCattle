...
namespace EFEntityAnalyzer
{
    ...
    public class EFEntityAnalyzer : DiagnosticAnalyzer
    {
        ...
        // to be localize-able, you can use regular strings for Title and MessageFormat. See
        // https://github.com/dotnet/roslyn/blob/main/docs/analyzers/Localizing%20Analyzers.md for
